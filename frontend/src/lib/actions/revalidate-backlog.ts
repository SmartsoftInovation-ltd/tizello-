 ...
 * `/board/backlog`, `/board/sprint-planning` and `/board/sprint` (the current
 * sprint board), and their project-scoped twins. One task write can move a row between the backlog and a sprint, so
